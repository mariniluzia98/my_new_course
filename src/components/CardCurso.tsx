  ...
  return (
    <div className="card glass-panel glass-panel-hover h-100 border-0 overflow-hidden">
      ...
      <div
        ...
        style={{ height: "8px", background: "var(--primary-glow)" }}
      ></div>
      ...
      <div className="card-body p-4 d-flex flex-column justify-content-between">
        <div>
          <div className="d-flex justify-content-between align-items-center mb-3">
            <span
              className="badge bg-secondary-subtle text-secondary badge-custom"
              style={{ fontSize: "0.75rem" }}
            >
              {categoriaNome}
            </span>
            <span
              className={`badge ${getNivelBadgeColor(curso.Nivel)} badge-custom`}
              style={{ fontSize: "0.75rem" }}
            >
              {curso.Nivel}
            </span>
          ...
          <h5 className="card-title text-primary-emphasis fw-bold mb-2">
            {curso.Titulo}
          </h5>
          <p
            className="card-text text-secondary fs-7 mb-4 line-clamp-3"
            style={{
              display: "-webkit-box",
              WebkitLineClamp: 3,
          ...
          {matriculado && (
            <div className="mb-4">
              <div className="d-flex justify-content-between align-items-center mb-1">
                ...
                <span className="text-white fw-semibold fs-8">
