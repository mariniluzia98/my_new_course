...
export const ActiveUserProvider: React.FC<{ children: React.ReactNode }> = ({ children }) => {
  ...
  return (
    <ActiveUserContext.Provider value={{ currentUser, setCurrentUser, usuarios, loading, reloadUsuarios }}>
      {children}
...
export const useActiveUser = () => {
  ...
  if (context === undefined) {
    throw new Error('useActiveUser deve ser usado dentro de um ActiveUserProvider');
  }
  return context;
};
